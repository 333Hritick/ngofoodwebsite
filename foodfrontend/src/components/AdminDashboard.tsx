...
export default function AdminDashboard() {
  ...
  <div className="min-h-screen bg-gray-100 lg:flex">
    ...
    {/* Mobile Header */}
    <div className="flex items-center justify-between bg-green-700 p-4 text-white lg:hidden">
      <h2 className="text-xl font-bold">Admin Panel</h2>

      <button
        onClick={() => setSidebarOpen(!sidebarOpen)}
        className="rounded bg-green-800 px-3 py-2"
      >
        ☰
      </button>
    </div>
    ...
    <aside
      className={`
        fixed left-0 top-0 z-50 h-full w-64 transform bg-green-700 p-5 text-white transition-transform duration-300
    ...
    >
      ...
      <button
        ...
        className="mt-10 flex w-full items-center justify-center gap-2 rounded bg-red-500 px-4 py-2 hover:bg-red-600"
      >
        <LogOut /> Logout
      </button>
    </aside>
    ...
    {selectedNGO && (() => {
      ...
      return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
          <div className="relative max-h-[90vh] w-[95%] max-w-3xl overflow-y-auto rounded-xl bg-white p-6">
